...
abstract public class ColumnUi1<C> implements Ui1<Column, C> {
    ...
    public ColumnUi2<C, ColumnUi> expandBottom() {
    ...
    public <C2, C3, C4> ColumnUi4<C, C2, C3, C4> expandBottom(final ColumnUi3<C2, C3, C4> expansion) {
        return ColumnUi4.create(new ColumnUi4.OnBind<C, C2, C3, C4>() {
            @Override
            public ColumnUi3<C2, C3, C4> onBind(C condition) {
                return ColumnUi1.this.bind(condition).expandBottom(expansion);
            }
        });
    }
